...
void stone_touch(edict_t* ent, edict_t* other, cplane_t* plane, csurface_t* surf)
{
	vec3_t		origin;
	int			n, phealth;
...
void fire_touch(edict_t* self, edict_t* other, cplane_t* plane, csurface_t* surf) 
{
	...
	T_RadiusDamage(self, self->owner, 30, other, 150, MOD_ROCKET);  
	G_FreeEdict(self); 
}
